...
from sqlalchemy import Column, Integer, String, DateTime, Float, LargeBinary, ForeignKey, event
...
class Image(Base):
    ...
    similar_to = relationship(
        "SimilarityMatch",
        foreign_keys="SimilarityMatch.image1_id",
        backref="source_image"
    )
    similar_from = relationship(
        "SimilarityMatch",
        foreign_keys="SimilarityMatch.image2_id",
        backref="target_image"
    )
